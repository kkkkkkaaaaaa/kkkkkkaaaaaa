...
namespace kkkkkkaaaaaa.Web.TableDataGateways
{
    ...
    /// 
    /// </summary>
    public class UserAttributeHistoriesGateway : KandaTableDataGateway
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public static DbDataReader Select(UserAttributeHistoryEntity entity, DbConnection connection, DbTransaction transaction)
        {
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static int Insert(UserAttributeHistoryEntity entity, DbConnection connection, DbTransaction transaction)
        {
            var command = KandaTableDataGateway._factory.CreateCommand(connection, transaction);

            command.CommandText = @"usp_InsertUserAttributeHistories";
        ...
        {
            return KandaTableDataGateway.Truncate(@"UserAttributeHistories", connection, transaction);
        }
    }
}
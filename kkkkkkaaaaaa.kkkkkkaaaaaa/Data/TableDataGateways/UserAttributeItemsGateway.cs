...
namespace kkkkkkaaaaaa.Data.TableDataGateways
{
    ...
    /// 
    /// </summary>
    internal class UserAttributeItemsGateway : KandaTableDataGateway
    {
        /// <summary>
        /// 
        /// </summary>
        public const string TABLE_NAME = @"UserAttributeItems";
        ...
        /// <returns></returns>
        public static KandaDbDataReader Select(UserAttributeItemsCriteria criteria, DbConnection connection, DbTransaction transaction)
        {
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static int Update(UserAttributeItemEntity entity, DbConnection connection, DbTransaction transaction)
        {
            var command = KandaTableDataGateway._factory.CreateCommand(connection, transaction);

            command.CommandText = @"usp_UpdateUserAttributeItems";
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static int Delete(UserAttributeItemsCriteria criteria, DbConnection connection, DbTransaction transaction)
        {
            var command = KandaTableDataGateway._factory.CreateCommand(connection, transaction);

            command.CommandText = @"usp_DeleteUserAttributeItems";
        ...
        {
            return KandaTableDataGateway.Truncate(UserAttributeItemsGateway.TABLE_NAME, connection, transaction);
        }
    }
}